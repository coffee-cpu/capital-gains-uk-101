...
import { TaxYearSummary, DisposalRecord, Section104Pool } from '../types/cgt'
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer}>
          Generated by Capital Gains Tax Visualiser on {new Date().toLocaleDateString('en-GB')} at {new Date().toLocaleTimeString('en-GB')}
        </Text>
      </Page>
    </Document>
  )
...
export default CGTReportDocument
